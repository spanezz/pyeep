...
from pyeep.models.messages.power import (
    IncreaseGroupPower,
    SetGroupPower,
    SetPower,
    SetRate,
...
class PowerOutputController(OutputController):
    ...
    @check_hub
    def on_power_min(self, adj) -> None:
        """
    ...
    @check_hub
    def on_power_max(self, adj) -> None:
        """
    ...
    @check_hub
    def on_manual_power(self, scale, scroll, value) -> None:
        """
    ...
    @check_hub
    def set_source_power(self, src: Component, power: float) -> None:
        """
    ...
    @check_hub
    def set_animated_power(self, power: float) -> None:
        """
    ...
    @check_hub
    def set_manual_power(self, power: int) -> None:
        """
